...
public class BActivityThread extends IBActivityThread.Stub {
    ...
    public synchronized void handleBindApplication(String packageName, String processName) {
        ...
        // ✅ WebView Suffix (Android 9+ Multi-process Safe)
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P && !sWebViewSuffixSet) {
            try {
                String suffix = (processName != null) ? processName : packageName;
        ...
        // ssl适配 (disabled to avoid network blocking in virtualization)
        ...
        try {
            ...
            // Preload WebView
            try {
                GmsCore.initLoginWebView(mInitialApplication);
            } catch (Throwable ignored) {}
            ...
            // seccomp bypass for isolated processes
    ...
    public void scheduleReceiver(ReceiverData data) throws RemoteException {
        ...
        mH.post(() -> {
            ...
            try {
                ...
                Slog.e(TAG, "Error receiving broadcast " + intent);
            }
        });
    }
